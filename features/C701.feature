...
#  And Click "Next" button
#  And Check "radio" button "Do NOT add addresses to my cards" is "selected"
#  And Click "Next" button
#  And Type "0" in "Order Unaddressed Cards" field
#  And Click "Next" button
#  Then I recieve an error "Error!Your order requires a minimum quantity of at least 25 items."
...
#  And Check "radio" button "Ship Order to me" is "selected"
#  And Click "Next" button
...
#  And Check "approved" button is "active"
...
#  Then I recieve an error "Error!Your order does not contain the number of photos required to place this order."
#  Then end of test.
...
#  When I Start running test case "C700"
  ...
  #And Click "Next" button
  #And Select "Pay by Credit or Debit Card" in "Billing" dropdown
  ...
  #Then "/next/landing/index.php" page should be displayed.
#  Then end of test.
#  
